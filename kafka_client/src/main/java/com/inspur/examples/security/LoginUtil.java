package com.inspur.examples.security;
...
public class LoginUtil
{
        ...
        throws IOException
    {
        ...
        System.out.println("JAVA_SECURITY_KRB5_CONF =" +ret);
        if (ret == null)
        {
